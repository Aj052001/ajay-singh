    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-dot-white/[0.2]">
      ...
      <div className="relative px-4 text-center mt-[-5vh]">
        <div className="space-y-4">
          ...
          <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl lg:text-7xl bg-clip-text text-transparent bg-gradient-to-b from-white to-white/70 animate-fade-in-up">
            ...
            <div className="block mt-2">
              ...
              <span className="inline-block perspective-1000">
                <div
                  className={`relative inline-block transition-transform duration-500 transform-style-preserve-3d ${
                    titleFlipped ? "rotate-x-180" : ""
                  }`}
                >
                  <span className="inline-block text-primary backface-hidden">
                    Engineer
                  </span>
                  <span className="inline-block text-primary absolute inset-0 rotate-x-180 backface-hidden">
                    Developer
                  </span>
                </div>
              </span>
          ...
          {/* Description */}
          <p className="mt-6 text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed animate-fade-in-up delay-200">
          Curious mind with a knack for solving complex problems, always eager to explore emerging technologies.
          Fueled by a growth mindset and committed to lifelong learning, I thrive in environments that challenge me to evolve and excel.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-6 mt-16 justify-center animate-fade-in-up delay-300">
            <Link href="#projects">
              <Button size="lg" className="relative group px-8 rounded-xl">
                <span className="absolute -inset-0.5 bg-gradient-to-r from-primary via-yellow-500 to-primary rounded-lg blur opacity-50 group-hover:opacity-100 transition duration-1000 group-hover:duration-200 "></span>
